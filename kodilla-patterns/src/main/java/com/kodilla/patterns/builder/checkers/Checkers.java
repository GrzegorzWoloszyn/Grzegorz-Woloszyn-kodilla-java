    ...
    public static class CheckersBuilder {
        ...
        public CheckersBuilder Figure(String figureType, String figureColor, int x, int y) {
            ...
            if(board.getFigure(x, y) == null) {
                ...
                throw new IllegalStateException("Position " + x + ", " + y + " is already taken");
            }
            return this;
        }
        ...
        public Checkers build() {
            if(playerOne.length() == 0) {
                throw new IllegalStateException("There is no player ONE, please specify.");
            } else if (playerTwo.length() == 0) {
                throw new IllegalStateException("There is no player TWO, please specify.");
            }
