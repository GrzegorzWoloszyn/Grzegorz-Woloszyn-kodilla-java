...
public final class SettingsFileEngine {
    private static SettingsFileEngine settingsFileEngineInstanceInstance = null;
    ...
    public static SettingsFileEngine getInstance() {
        if (settingsFileEngineInstanceInstance == null) {
            synchronized (SettingsFileEngine.class) {
                if (settingsFileEngineInstanceInstance == null) {
                    settingsFileEngineInstanceInstance = new SettingsFileEngine();
                }
            }
        }
        return settingsFileEngineInstanceInstance;
    }
